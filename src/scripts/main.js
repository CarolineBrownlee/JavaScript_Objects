...
// Use square bracket notation if your key is in a variable. (Loops)
...
// ***** Start of GitHub Objects Practice ***** //
...
// !!! Example from MND Array.protype.find() !!! //
...
const answer = githubData.find( ({ id }) => id == 8030403992);
console.log(answer)

console.log(answer.payload.commits[0].message);
